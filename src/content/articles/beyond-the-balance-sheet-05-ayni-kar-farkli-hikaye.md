---
title: "Aynı Kâr, Farklı Hikaye"
tarih: 2026-05-28
kaynak: "X — @yalcinarsan"
url: "https://x.com/yalcinarsan/status/2060082446457074075"
dil: tr
kategori: sirket-analizi
seri: beyond-the-balance-sheet
seriNo: 5
seriBaslik: "Kârlılığı ölçmek"
durum: yayında
...
<figure>
<img src="/images/articles/ayni-kar-farkli-hikaye/01-markup-vs-kar-marji.png" alt="Aynı işlem, iki farklı hesap: 100 TL'ye alınan ürün 150 TL'ye satılıyor, 50 TL kâr. Mark-up (maliyet üzerinden, ticaret dili): Kâr ÷ Maliyet = 50 ÷ 100 = %50. Kâr marjı (ciro üzerinden, finansal analiz dili): Kâr ÷ Ciro = 50 ÷ 150 = %33. Aynı 50 TL kâr — ama iki farklı yüzde; mark-up satıcının fiyatlama disiplinini, kâr marjı işletmenin verimliliğini gösterir." />
<figcaption>Aynı işlem, iki farklı hesap: mark-up ve kâr marjı.</figcaption>
</figure>
...
<figure>
<img src="/images/articles/ayni-kar-farkli-hikaye/02-kar-marji-katmanlari.png" alt="Üç sektörde kâr marjı katmanları. Yazılım (yüksek marj): brüt kâr %85, faaliyet kârı %25, net kâr %18 — az satıştan çok kâr. Üretim (orta marj): brüt %35, faaliyet %10, net %6 — dengeli model. Perakende (düşük marj): brüt %20, faaliyet %4, net %2 — çok satıştan az kâr. Marj sadece tek rakam değil; her katman ayrı bir soruya cevap verir." />
<figcaption>Gelir tablosunun her katmanı ayrı bir marj üretir — ve sektöre göre tamamen farklı görünür.</figcaption>
</figure>
...
<figure>
<img src="/images/articles/ayni-kar-farkli-hikaye/03-marj-devir-tahterevalli.png" alt="Marj ve devir hızı tahterevallisi. Yüksek marj · düşük devir (lüks markalar, niş yazılım): marj %20 × devir hızı 1.0x = ROTA %20. Düşük marj · yüksek devir (süpermarket, indirim mağazaları): marj %5 × devir hızı 4.0x = ROTA %20. Aynı ROTA, iki farklı yoldan — marjdan kaybettiğinizi devir hızından kazanırsınız, ya da tam tersi." />
<figcaption>Aynı aktif kârlılığına iki farklı yoldan ulaşılabilir.</figcaption>
</figure>

## DuPont Analizi: Tek Oranın Üç Bileşeni

20. yüzyılın başında DuPont kimya şirketinin finansçıları, kendi şirketlerini analiz ederken finans dünyasına basit ama güçlü bir fikir kattılar: özsermaye kârlılığını (ROE) tek bir rakam olarak değil, üç bileşenin çarpımı olarak okumak.
...
<figure>
<img src="/images/articles/ayni-kar-farkli-hikaye/04-dupont-analizi.png" alt="DuPont denklemi: Net kâr marjı (operasyonel ustalık) × Aktif devir hızı (operasyonel verim) × Finansal kaldıraç (borç riski) = ROE (özsermaye getirisi). Üç farklı şirket, aynı %25 ROE — ama hikayeleri farklı. A (sağlıklı, sürdürülebilir): %12 × 1.4x × 1.5x. B (operasyonel olarak çok verimli): %5 × 3.3x × 1.5x. C (yüksek borçla şişirilmiş, Lehman örneği): %4 × 1.0x × 6.0x. ROE size ne olduğunu söyler — neden olduğunu söylemez." />
<figcaption>Aynı ROE, üç farklı hikaye: DuPont ayrıştırması "neden" sorusunu sormaya zorlar.</figcaption>
</figure>
