---
title: "Otomotivde Yeni Ekonomi"
tarih: 2026-06-26
kaynak: "X — @yalcinarsan"
url: "https://x.com/yalcinarsan/status/2070432357719453962"
dil: tr
...
kapakGorseli:
  src: "/images/articles/yeni-ekonomi/00-karakalem-yeni-ekonomi-v1.webp"
  srcMobil: "/images/articles/yeni-ekonomi/00-karakalem-yeni-ekonomi-v1-mobile.webp"
  paylasim: "/images/articles/yeni-ekonomi/00-karakalem-yeni-ekonomi-v1-og.jpg"
...
<figure>
<img src="/images/articles/yeni-ekonomi/01-kazanan-kaybeden-alt-sektorler.png" alt="Kazanan ve kaybeden alt sektörler: Büyüyen alanlar — batarya hücre+modül+paket (litium hücreler, BMS, soğutma plakası), güç elektroniği (invertör, on-board charger, DC-DC dönüştürücü), yazılım+bağlantı (OTA güncelleme, ADAS, infotainment), termal yönetim (soğutma sıvısı pompası, ısı pompası, batarya soğutma), hafif malzeme (alüminyum gövde, karbon kompozit, mühendislik plastiği). Küçülen alanlar — motor parçaları (piston, krank mili, silindir kafası), şanzıman (çoklu vites kutusu, debriyaj, tork konvertör), egzoz sistemi (katalitik konvertör, susturucu, EGR), yakıt sistemi (yakıt pompası, enjektör, yakıt tankı), klasik filtrasyon (yağ filtresi, yakıt filtresi)." />
<figcaption>Kazanan ve Kaybeden Alt Sektörler.</figcaption>
</figure>
...
<figure>
<img src="/images/articles/yeni-ekonomi/02-sarj-senaryolari.png" alt="Elektrikli araç şarj senaryoları: Enroute (otoyol) — 15-40 dk hızlı (DC), otoyol/mola noktaları, baskın oyuncu yağ şirketleri + büyük operatörler. Destination (varış noktası) — 1-8 saat orta (AC/DC), AVM/market/otel/restoran, baskın oyuncu perakende sahipleri + üçüncü taraf operatörler. İş yerinde — 6-10 saat yavaş (AC), ofis otoparkı, baskın oyuncu işveren. Halka açık şehir içi — 1-4 saat (AC/DC), sokak/otopark, baskın oyuncu belediyeler + bağımsız operatörler." />
<figcaption>Elektrikli araç şarj senaryoları.</figcaption>
</figure>
...
<figure>
<img src="/images/articles/yeni-ekonomi/03-ilk-bes-operator.png" alt="Türkiye'de ilk beş şarj operatörü, soket sayısı (Mayıs 2026) ve sahibi: 1. ZES — 5.542 soket (3.082 AC + 2.460 DC), Zorlu Holding. 2. Trugo — 3.550 soket (685 AC + 2.865 DC, DC ağırlıklı), Togg (%100 iştirak). 3. Voltrun — 2.485 soket (2.235 AC + 250 DC, AC ağırlıklı), bağımsız. 4. Wat — 2.238 soket, Koç Holding. 5. Eşarj — 2.121 soket, Enerjisa (Sabancı + E.ON ortak girişimi). Kaynak: EPDK Şarj Hizmeti Piyasası Aylık İstatistikleri, Mayıs 2026." />
<figcaption>Türkiye'nin ilk beş şarj operatörü ve pazar dağılımı.</figcaption>
</figure>
...
<figure>
<img src="/images/articles/yeni-ekonomi/04-tesla-togg-trugo.png" alt="Tesla (küresel) ve Togg-Trugo (Türkiye) karşılaştırması: Ağ ölçeği — Tesla ~80.000 cihaz/8.502 nokta, Togg-Trugo 3.550 soket (2.865 DC), sadece Türkiye. Marka-şarj entegrasyonu — Tesla çekirdek model, Togg-Trugo aynı mantık (araç ve şarj tek elden). Enerji satışında pazar payı — Tesla lider (operasyon ülkelerinde), Togg-Trugo Türkiye'de %21,84 ile birinci (EPDK Mayıs 2026). Yüksek hız ağı — Tesla 250+ kW, Togg-Trugo 180+ kW (Shell istasyonlarında konumlandırılmış). Yazılım entegrasyonu — Tesla sektör lideri, Togg-Trugo geliştirilebilir. Açık ağ (diğer markalara) — Tesla evet, Togg-Trugo başından beri açık. Lokasyon stratejisi — Tesla kendi siteleri, Togg-Trugo Shell ortaklığı (yerel avantaj)." />
<figcaption>Tesla ve Togg-Trugo modelinin karşılaştırması.</figcaption>
</figure>
...
- [Houston.org](https://houston.org/): Shell, BP Advancing Energy Transition Efforts
...
- ["Otomotivde Neler Oluyor? — EV Geçişinin Finansal Anatomisi"](/makaleler/otomotivde-elektrifikasyon-01-neler-oluyor) (Şubat 2026)
- ["Otomotivde Neler Olacak? — EA Geçişinin Yakın Geleceği"](/makaleler/otomotivde-elektrifikasyon-02-bundan-sonra-ne-olacak) (Mart 2026)
- ["Otomotivde Kim Ne Yapmalı? — Marka, Distribütör ve Bayi Arasında Yeni Denge Arayışı"](/makaleler/otomotivde-elektrifikasyon-03-kim-ne-yapmali) (Nisan 2026)
- ["Müşteri Ne Diyor: Otomotivde Elektrikliye Geçişin Asıl Belirleyicisi"](/makaleler/otomotivde-elektrifikasyon-04-musteri-ne-diyor) (Mayıs 2026)
